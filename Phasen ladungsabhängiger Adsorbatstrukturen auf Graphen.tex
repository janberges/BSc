...
\usepackage[labelfont=bf, font=small, parindent=0.5cm]{subcaption}
...
\begin{document}
	...
	\begin{figure}[t]
		\begin{minipage}[b]{0.46\textwidth}
			\includegraphics[width=\textwidth]{../Raumstrukturen/Graphit.pdf}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.48\textwidth]{../Raumstrukturen/Graphen.pdf}
	...
	\begin{figure}
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Bandstrukturen/BZ_C2_1.pdf}
			\subcaption{Konturdarstellung des Leitungsbands mit Symmetriepfad in angepassten Koordinaten}
		\end{minipage}
		\hfill
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Bandstrukturen/C2.pdf}
	...
	\begin{figure}
		...
		\hfill
		\begin{minipage}[b]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Zustandsdichten/Ortsraumbeispiel.pdf}
	...
	\begin{figure}
		\includegraphics[width=\textwidth]{../Bandstrukturen/DOS_C2.pdf}
	...
	%
	\begin{figure}
		\includegraphics[width=0.48\textwidth]{../Bandstrukturen/C2X2.pdf}
		\hfill
		\includegraphics[width=0.48\textwidth]{../Bandstrukturen/DOS_C2X2.pdf}
	...
	%
	\begin{figure}
		\includegraphics[width=0.48\textwidth]{../Bandstrukturen/C2X.pdf}
		\hfill
		\includegraphics[width=0.48\textwidth]{../Bandstrukturen/DOS_C2X.pdf}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.48\textwidth]{../Raumstrukturen/Sechstel.pdf}
	...
	%
	\begin{figure}
		\includegraphics[width=0.48\textwidth]{../Bandstrukturen/C6X.pdf}
		\hfill
		\includegraphics[width=0.48\textwidth]{../Bandstrukturen/DOS_C6X.pdf}
	...
	\begin{figure}
		\includegraphics[width=\textwidth]{../Zustandsdichten/75.pdf}
	...
	\begin{figure}
		...
		\hfill
		\begin{minipage}[b]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Schemata/H_penalty.pdf}
		...
		\hfill
		\begin{minipage}[b]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Schemata/F_penalty.pdf}
	...
	\begin{figure}[b]
		\begin{minipage}[t]{0.31\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Exakt/img/H_G.pdf}
			\subcaption{Wasserstoff, Gruppierung}
			\label{HGx}
		\end{minipage}
		\hfill
		\begin{minipage}[t]{0.31\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Exakt/img/H_K.pdf}
			\subcaption{Wasserstoff, Kompaktheit}
			\label{HKx}
		\end{minipage}
		\hfill
		\begin{minipage}[t]{0.31\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Exakt/img/H_D.pdf}
		...
		\begin{minipage}[t]{0.31\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Exakt/img/H_P.pdf}
		...
		\hfill
		\begin{minipage}[t]{0.31\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Exakt/img/F_P.pdf}
		...
		\begin{minipage}[t]{0.31\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Exakt/img/F_G.pdf}
			\subcaption{Fluor, Gruppierung}
			\label{FGx}
		\end{minipage}
		\hfill
		\begin{minipage}[t]{0.31\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Exakt/img/F_K.pdf}
			\subcaption{Fluor, Kompaktheit}
			\label{FKx}
		\end{minipage}
		\hfill
		\begin{minipage}[t]{0.31\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Exakt/img/F_D.pdf}
	...
	\begin{figure}
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Bandstrukturen/BZ_C6X_4.pdf}
			\subcaption{drittgrößte Eigenenergien}
		\end{minipage}
		\hfill
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Bandstrukturen/BZ_C6X_5.pdf}
	...
	%
	\begin{figure}
		\includegraphics[width=\textwidth]{../Zustandsdichten/84.pdf}
	...
	\begin{figure}
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/H_cluster_G.pdf}
			\subcaption{$\rm C_2H_2$-Inseln, $p = 0$}
			\label{H_cluster_G}
		\end{minipage}
		\hfill
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/H_penalty_cluster_G.pdf}
			\subcaption{$\rm C_2H_2$-Inseln, $p = 0.5\,\mathrm{eV}$}
			\label{H_penalty_cluster_G}
		\end{minipage}
		%
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/H_random_G.pdf}
			\subcaption{zufällig, $p = 0$}
			\label{H_random_G}
		\end{minipage}
		\hfill
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/H_penalty_random_G.pdf}
			\subcaption{zufällig, $p = 0.5\,\mathrm{eV}$}
			\label{H_penalty_random_G}
		\end{minipage}
		%
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/H_individual_G.pdf}
			\subcaption{individuell, $p = 0$}
			\label{H_individual_G}
		\end{minipage}
		\hfill
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/H_penalty_individual_G.pdf}
	...
	\begin{figure}
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/H_cluster_K.pdf}
			\subcaption{$\rm C_2H_2$-Inseln, $p = 0$}
			\label{H_cluster_K}
		\end{minipage}
		\hfill
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/H_penalty_cluster_K.pdf}
			\subcaption{$\rm C_2H_2$-Inseln, $p = 0.5\,\mathrm{eV}$}
			\label{H_penalty_cluster_K}
		\end{minipage}
		%
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/H_random_K.pdf}
			\subcaption{zufällig, $p = 0$}
			\label{H_random_K}
		\end{minipage}
		\hfill
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/H_penalty_random_K.pdf}
			\subcaption{zufällig, $p = 0.5\,\mathrm{eV}$}
			\label{H_penalty_random_K}
		\end{minipage}
		%
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/H_individual_K.pdf}
			\subcaption{individuell, $p = 0$}
			\label{H_individual_K}
		\end{minipage}
		\hfill
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/H_penalty_individual_K.pdf}
			\subcaption{individuell, $p = 0.5\,\mathrm{eV}$}
	...
	\begin{figure}
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/H_cluster_D.pdf}
			\subcaption{$\rm C_2H_2$-Inseln, $p = 0$}
			\label{H_cluster_D}
		\end{minipage}
		\hfill
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/H_penalty_cluster_D.pdf}
			\subcaption{$\rm C_2H_2$-Inseln, $p = 0.5\,\mathrm{eV}$}
			\label{H_penalty_cluster_D}
		\end{minipage}
		%
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/H_random_D.pdf}
			\subcaption{zufällig, $p = 0$}
			\label{H_random_D}
		\end{minipage}
		\hfill
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/H_penalty_random_D.pdf}
			\subcaption{zufällig, $p = 0.5\,\mathrm{eV}$}
			\label{H_penalty_random_D}
		\end{minipage}
		%
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/H_individual_D.pdf}
			\subcaption{individuell, $p = 0$}
			\label{H_individual_D}
		\end{minipage}
		\hfill
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/H_penalty_individual_D.pdf}
			\subcaption{individuell, $p = 0.5\,\mathrm{eV}$}
	...
	\begin{figure}
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/H_cluster_P.pdf}
			\subcaption{$\rm C_2H_2$-Inseln, $p = 0$}
			\label{H_cluster_P}
		\end{minipage}
		\hfill
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/H_penalty_cluster_P.pdf}
			\subcaption{$\rm C_2H_2$-Inseln, $p = 0.5\,\mathrm{eV}$}
			\label{H_penalty_cluster_P}
		\end{minipage}
		%
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/H_random_P.pdf}
			\subcaption{zufällig, $p = 0$}
			\label{H_random_P}
		\end{minipage}
		\hfill
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/H_penalty_random_P.pdf}
			\subcaption{zufällig, $p = 0.5\,\mathrm{eV}$}
			\label{H_penalty_random_P}
		\end{minipage}
		%
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/H_individual_P.pdf}
			\subcaption{individuell, $p = 0$}
			\label{H_individual_P}
		\end{minipage}
		\hfill
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/H_penalty_individual_P.pdf}
			\subcaption{individuell, $p = 0.5\,\mathrm{eV}$}
	...
	\begin{figure}
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/F_cluster_G.pdf}
			\subcaption{$\rm C_2F_2$-Inseln, $p = 0$}
			\label{F_cluster_G}
		\end{minipage}
		\hfill
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/F_penalty_cluster_G.pdf}
			\subcaption{$\rm C_2F_2$-Inseln, $p = 0.5\,\mathrm{eV}$}
			\label{F_penalty_cluster_G}
		\end{minipage}
		%
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/F_random_G.pdf}
			\subcaption{zufällig, $p = 0$}
			\label{F_random_G}
		\end{minipage}
		\hfill
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/F_penalty_random_G.pdf}
			\subcaption{zufällig, $p = 0.5\,\mathrm{eV}$}
			\label{F_penalty_random_G}
		\end{minipage}
		%
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/F_individual_G.pdf}
			\subcaption{individuell, $p = 0$}
			\label{F_individual_G}
		\end{minipage}
		\hfill
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/F_penalty_individual_G.pdf}
			\subcaption{individuell, $p = 0.5\,\mathrm{eV}$}
	...
	\begin{figure}
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/F_cluster_K.pdf}
			\subcaption{$\rm C_2F_2$-Inseln, $p = 0$}
			\label{F_cluster_K}
		\end{minipage}
		\hfill
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/F_penalty_cluster_K.pdf}
			\subcaption{$\rm C_2F_2$-Inseln, $p = 0.5\,\mathrm{eV}$}
			\label{F_penalty_cluster_K}
		\end{minipage}
		%
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/F_random_K.pdf}
			\subcaption{zufällig, $p = 0$}
			\label{F_random_K}
		\end{minipage}
		\hfill
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/F_penalty_random_K.pdf}
			\subcaption{zufällig, $p = 0.5\,\mathrm{eV}$}
			\label{F_penalty_random_K}
		\end{minipage}
		%
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/F_individual_K.pdf}
			\subcaption{individuell, $p = 0$}
			\label{F_individual_K}
		\end{minipage}
		\hfill
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/F_penalty_individual_K.pdf}
			\subcaption{individuell, $p = 0.5\,\mathrm{eV}$}
	...
	\begin{figure}
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/F_cluster_D.pdf}
			\subcaption{$\rm C_2F_2$-Inseln, $p = 0$}
			\label{F_cluster_D}
		\end{minipage}
		\hfill
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/F_penalty_cluster_D.pdf}
			\subcaption{$\rm C_2F_2$-Inseln, $p = 0.5\,\mathrm{eV}$}
			\label{F_penalty_cluster_D}
		\end{minipage}
		%
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/F_random_D.pdf}
			\subcaption{zufällig, $p = 0$}
			\label{F_random_D}
		\end{minipage}
		\hfill
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/F_penalty_random_D.pdf}
			\subcaption{zufällig, $p = 0.5\,\mathrm{eV}$}
			\label{F_penalty_random_D}
		\end{minipage}
		%
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/F_individual_D.pdf}
			\subcaption{individuell, $p = 0$}
			\label{F_individual_D}
		\end{minipage}
		\hfill
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/F_penalty_individual_D.pdf}
			\subcaption{individuell, $p = 0.5\,\mathrm{eV}$}
	...
	\begin{figure}
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/F_cluster_P.pdf}
			\subcaption{$\rm C_2F_2$-Inseln, $p = 0$}
			\label{F_cluster_P}
		\end{minipage}
		\hfill
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/F_penalty_cluster_P.pdf}
			\subcaption{$\rm C_2F_2$-Inseln, $p = 0.5\,\mathrm{eV}$}
			\label{F_penalty_cluster_P}
		\end{minipage}
		%
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/F_random_P.pdf}
			\subcaption{zufällig, $p = 0$}
			\label{F_random_P}
		\end{minipage}
		\hfill
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/F_penalty_random_P.pdf}
			\subcaption{zufällig, $p = 0.5\,\mathrm{eV}$}
			\label{F_penalty_random_P}
		\end{minipage}
		%
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/F_individual_P.pdf}
			\subcaption{individuell, $p = 0$}
			\label{F_individual_P}
		\end{minipage}
		\hfill
		\begin{minipage}[t]{0.48\textwidth}
			\includegraphics[width=\textwidth]{../Phasendiagramme/Konturen/img/F_penalty_individual_P.pdf}
			\subcaption{individuell, $p = 0.5\,\mathrm{eV}$}
	...
	\lstinputlisting[language = Python, firstline = 4]{/Users/jan/Sites/graphene/graphene.py}
	
	\section{index.py}
	
	\lstinputlisting[language = Python, firstline = 4]{/Users/jan/Sites/graphene/index.py}
	
	\section{script.js}
	
	\lstinputlisting[language = JavaScript]{/Users/jan/Sites/graphene/script.js}
